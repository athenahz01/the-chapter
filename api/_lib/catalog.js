// AUTO-EXTRACTED from src/App.jsx BOOKS — minimal catalog for server-side
// use (cron delivery). If you add/remove books in App.jsx, keep this in sync.
...
export const byId = (id) => CATALOG.find(b => b.id === id) || null;
